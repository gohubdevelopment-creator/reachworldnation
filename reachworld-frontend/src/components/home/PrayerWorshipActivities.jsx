...
const PrayerWorshipActivities = () => {
  const activities = [
    ...
    },
    {
      ...
      color: 'from-accent-purple to-primary-blue',
  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        >
          <span className="inline-block bg-primary-gold/20 text-primary-gold px-4 py-2 rounded-full font-semibold text-sm mb-4">
            Join Our Activities
          </span>
            ...
            >
              <div className={`bg-gradient-to-br ${activity.color} rounded-xl p-6 text-white h-full shadow-lg hover:shadow-2xl transition-shadow duration-300 relative overflow-hidden`}>
                ...
                <div className="relative z-10">
                  ...
                  {/* CTA Button */}
                  <button className="w-full bg-neutral-white text-neutral-dark py-2 rounded-lg font-semibold hover:bg-primary-gold hover:text-neutral-dark transition-all duration-300">
                    Join Activity
                  </button>
                </div>
              </div>
